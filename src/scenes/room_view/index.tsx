...
interface IRoomViewScreen extends NavigationComponentProps {

}
const RoomViewScreen: React.FC<IRoomViewScreen> = (props) => {
  const { componentId } = props
  const buttonText = <View style={{ ...Mixins.row, alignItems: 'flex-end' }}>
    <Text style={Typography.font({ ...buttonTextStyle, weight: '500' }) as TextStyle}>Choose Rooms from </Text>
    <Text style={Typography.font({ ...buttonTextStyle, weight: 'bold' }) as TextStyle}>$47</Text>
...
const styles = StyleSheet.create({
  night: {
    ...Typography.font({ size: 10, color: Colors.PRIMARY }),
